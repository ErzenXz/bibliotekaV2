...
function updateText() {
  ...
  document.getElementById("video2").src = video;
  document.getElementById("video3").src = video;
...
const query = firebase.database().ref('mcomments/' + key + "/").limitToLast(100);
...
function sendMessage() {
  ...
  firebase.database().ref("mcomments/" + key).push().set({
    message: message,
    time: time.getTime(),
    key: key
  });
